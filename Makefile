...
help:
	...
	@echo ""
	@echo "Local CI (Docker required; OrbStack on macOS recommended):"
	@echo "  make ci-local       - run CI against the working tree (--no-matrix, fast)"
	@echo "  make ci-local-full  - run the full matrix locally"
	@echo ""
